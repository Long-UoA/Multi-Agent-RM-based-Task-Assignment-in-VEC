...
for iIter=1:numIter
    ...
    numReq=75; % number of requesting vehicles
...
Fairness75vehicles = tempSumNum^2/(numReq*tempSumDen);

save sumPayoff75vehicles.mat sumPayoff

save Fairness75vehicles.mat Fairness75vehicles
