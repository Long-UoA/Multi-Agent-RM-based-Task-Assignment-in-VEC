...
for iIter=1:numIter
    ...
    numReq=50; % number of requesting vehicles
...
Fairness50vehicles = tempSumNum^2/(numReq*tempSumDen);

save sumPayoff50vehicles.mat sumPayoff

save Fairness50vehicles.mat Fairness50vehicles
