...
for iIter=1:numIter
    ...
    lambda=0.9999; % regretting factor
    %-----------------------RSU location---------------------------------------
    nodesX(1)=1000;
    nodesY(1)=1000;
    nodesX(2)=nodesX(1)+D;
...
save sumPayoffLambda_09999.mat sumPayoff

save sumPayoffDelayLambda_09999.mat sumPayoffDelay

save sumPayoffCostLambda_09999.mat sumPayoffCost
